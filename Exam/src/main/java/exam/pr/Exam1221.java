...
public class Exam1221 {
	...
	@Test
	public void test() {
		assertEquals(new Exam1221().solution("...!@BaT#*..y.abcdefghijklm"), "bat.y.abcdefghi");
		assertEquals(new Exam1221().solution("z-+.^."), "z--");
		assertEquals(new Exam1221().solution("=.="), "aaa");
		assertEquals(new Exam1221().solution("123_.def"), "123_.def");
		assertEquals(new Exam1221().solution("abcdefghijklmn.p"), "abcdefghijklmn");
	}
}
