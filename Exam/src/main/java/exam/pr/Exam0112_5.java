...
public class Exam0112_5 {
	...
	@Test
	public void test() {
		assertTrue(new Exam0112_5().solution(10));
		assertTrue(new Exam0112_5().solution(12));
		assertFalse(new Exam0112_5().solution(11));
		assertFalse(new Exam0112_5().solution(13));
	}
}
