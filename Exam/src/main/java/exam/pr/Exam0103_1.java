...
public class Exam0103_1 {
	...
	@Test
	public void test() {
		assertEquals(new Exam0103_1().solution(new int[][] {{60, 50}, {30, 70}, {60, 30}, {80, 40}}), 4000);
		assertEquals(new Exam0103_1().solution(new int[][] {{10, 7}, {12, 3}, {8, 15}, {14, 7}, {5, 15}}), 120);
		assertEquals(new Exam0103_1().solution(new int[][] {{14, 4}, {19, 6}, {6, 16}, {18, 7}, {7, 11}}), 133);
	}
}
