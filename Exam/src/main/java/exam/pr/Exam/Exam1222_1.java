...
public class Exam1222_1 {
	...
	@Test
	public void test() {
		assertEquals(new Exam1222_1().solution("one4seveneight"), 1478);
		assertEquals(new Exam1222_1().solution("23four5six7"), 234567);
		assertEquals(new Exam1222_1().solution("2three45sixseven"), 234567);
	}
}
