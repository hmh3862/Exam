...
public class Exam0111_5 {
	...
	@Test
	public void test() {
		assertArrayEquals(new Exam0111_5().solution(new int[] {4,3,2,1}), new int[] {4,3,2});
		assertArrayEquals(new Exam0111_5().solution(new int[] {10}), new int[] {-1});
	}
}
